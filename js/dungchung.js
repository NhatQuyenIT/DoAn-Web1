...
function addHeader() {
	...
	<div class="header group">
        <div class="logo">
            <a href="index.html">
                <img src="img/logo.png" alt="Trang chủ Smartphone Store" title="Trang chủ Smartphone Store" style="width: 50%; height: 100%">
                <span style="text-transform:uppercase;color:red;font-weight:bold;font-family: Arial, Helvetica, sans-serif;">Hoàn Hảo PC</span>
...
function addFooter() {
    ...
    <div class="copy-right">
        <p><a href="index.html">Hoàn Hảo Store</a> - All rights reserved © 2023 - Designed by
